...
namespace Project_Iuga_Dorut.Controllers
{
    ...
    public class ProducersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProducerID,Name,Location")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProducerID,Name,Location")] Producer producer)
        {
